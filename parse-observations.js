...
{ old: 'Hamadryas februa', name: 'Hamadryas ferox', commonName: 'Caribbean Cracker', onlyInLocation: 'Puerto Rico' },
  { old: 'Athyma nefte', name: 'Athyma inara', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Acraea violae', name: 'Acraea terpsicore', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Aeromachus stigmatus', name: 'Aeromachus stigmata', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Choaspes hemixanthus', name: 'Choaspes furcatus', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Chrysozephyrus syla', name: 'Inomataozephyrus syla', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Cupido huegelii', name: 'Huegelia hugelii', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Cupido argiades', name: 'Everes argiades', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Graphium clanis', name: 'Graphium chironides', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Hestina nama', name: 'Hestinalis nama', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Issoria lathonia', name: 'Issoria issaea', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Libythea celtis', name: 'Libythea lepita', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Limenitis danava', name: 'Auzakia danava', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Limenitis procris', name: 'Moduza procris', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Lycaena pavana', name: 'Lycaena panava', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Mycalesis heri', name: 'Telinga heri', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Mycalesis nicotia', name: 'Telinga nicotia', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Pathysa nomius', name: 'Graphium nomius', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Pareronia valeria', name: 'Pareronia hippia', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Parnara guttata', name: 'Parnara guttatus', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Sebastronyma dolopia', name: 'Sebastonyma dolopia', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Spalgis epeus', name: 'Spalgis epius', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Syntarucus plinius', name: 'Leptotes plinius', commonName: null, onlyInLocation: 'Nepal' },
{ old: 'Tajuria maculata', name: 'Tajuria maculatus', commonName: null, onlyInLocation: 'Nepal' },
